...
app.use(cors({
    origin: ['*', 'http://127.0.0.1:5500', 'http://127.0.0.1:5501', 'http://localhost:5173' ,'https://imane2.netlify.app' , 'https://gleeful-lokum-86f064.netlify.app']  // Allow both front-end origins
